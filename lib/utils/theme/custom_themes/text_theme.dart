...
class TTextTheme{
  ...
  static TextTheme lightTextTheme = TextTheme(
    ...
    headlineSmall: const TextStyle().copyWith(fontSize: 11.0, fontWeight: FontWeight.w600 , color: Colors.black),
  ...
  static TextTheme darkTextTheme = TextTheme(
    ...
    headlineSmall: const TextStyle().copyWith(fontSize: 11.0, fontWeight: FontWeight.w600 , color: Colors.white),
